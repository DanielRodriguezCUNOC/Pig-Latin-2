...
public class ASTBuilder extends LatinParserBaseVisitor<ASTNode> {
    ...
    @Override
    public ASTNode visitGlobalDeclarations(LatinParser.GlobalDeclarationsContext ctx) {
        List<ASTNode> declarations = new ArrayList<>();
        for (LatinParser.GlobalDeclarationContext declCtx : ctx.globalDeclaration()) {
            ASTNode decl = visit(declCtx);
            if (decl != null)
                declarations.add(decl);
        }
        return (ASTNode) declarations;
    }

    @Override
    public ASTNode visitGlobalDeclarationDeclaration(LatinParser.GlobalDeclarationDeclarationContext ctx) {
        return visit(ctx.declaration());
    }

    @Override
    public ASTNode visitGlobalDeclarationArrayDeclaration(LatinParser.GlobalDeclarationArrayDeclarationContext ctx) {
